...
class PoissonBlock(nn.Module):
    ...
    """
    def __init__(self, n_input_channel:int, finite_difference_method:nn.Module, kernel_size:int=3, n_base_features:int=64, padding_mode:str="constant"):
        ...
        self.conv = nn.Sequential(
            ...
            nn.LeakyReLU(0.2),
            ResNet(n_base_features, [n_base_features, n_base_features], kernel_size, False, padding_mode),
